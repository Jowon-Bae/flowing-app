    ...
    >
      ...
      >
        <button 
          ...
          className="w-full bg-primary-50 text-primary-700 py-4 px-6 rounded-none font-bold text-lg border border-primary-200 flex items-center justify-center hover:bg-primary-100 transition-colors"
        >
          Go 아웃리치 팀
        </button>
        ...
        <button 
          ...
          className="w-full bg-white text-gray-900 py-4 px-6 rounded-none font-bold text-lg shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 flex items-center justify-center hover:bg-gray-50 transition-colors"
        >
          Send 중보기도 팀
        </button>
      </motion.div>
